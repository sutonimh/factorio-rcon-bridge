...
-- NOTE: the travel* chunks (native-pathfinder request/queue/tick walker) were REMOVED
-- 2026-08-30: they registered script.on_event/on_nth_tick at runtime, which changes the
-- level's handler set and REJECTS joining clients ('mod event handlers are not identical').
-- Long-distance movement stays in autopilot.walk() (Python-polled legs).
